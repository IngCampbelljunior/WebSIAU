...
DROP PROCEDURE IF EXISTS `Insert_solicitudDocSiau`$$

CREATE DEFINER=`hgarcia`@`%` PROCEDURE `Insert_solicitudDocSiau`(parsolicitud_id INT(11),
  ...
  parentesco_solicita VARCHAR(60),
